...
export default function CrearM({ children, titulo }: any) {
...
className="cursor-pointer inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
    ...
    <span className="w-full">{titulo ? titulo : ''}</span>
